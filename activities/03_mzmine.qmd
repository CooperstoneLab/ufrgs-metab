...
You can find a link [here](https://buckeyemailosu-my.sharepoint.com/:f:/g/personal/cooperstone_1_osu_edu/Em__DQbIlCBBuadrLMNDr8gB7-_tQayjX1JSzSdubjwhQA?e=QZdzx4) to a OneDrive folder that contains all the raw data files to download.
...
Create a directory (i.e., folder) with your name (no spaces) within `/fs/ess/PAS2568`. This is where you will save all your files. 
