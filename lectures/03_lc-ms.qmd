...
::: incremental
-   The process of separating components of a <br>mixture
-   Based on an analytes' difference in <br>partitioning between a stationary <br>and mobile phases
:::

![](img/03/chromatography.png){.absolute bottom="20" right="50"}

[https://en.wikipedia.org/wiki/Chromatography]{.aside style="font-size:0.5em;"}
...
::: {.column width="60%" style="font-size: 23px"}
